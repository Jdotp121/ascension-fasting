-- ============================================================================
-- ACHIEVEMENTS SYSTEM - RUN THIS IN SUPABASE SQL EDITOR
-- ============================================================================
-- This SQL creates the achievements system that is currently missing
-- from your database, causing the error:
-- "Could not find the function public.check_and_award_achievements"
-- ============================================================================

-- Step 1: Create user_achievements table
-- ============================================================================
...
DROP POLICY IF EXISTS "Users cannot update achievements" ON user_achievements;
DROP POLICY IF EXISTS "Users cannot delete achievements" ON user_achievements;
...
-- Users cannot update achievements (permanent record)
...
-- ============================================================================
-- Step 3: Create the achievement checking function
-- ============================================================================
-- Drop the function if it exists (to avoid errors on re-run)
...
-- 2. The "Error checking achievements" should be GONE
-- 3. Navigate to Weight page and add a weight entry
-- 4. "First Weight Entry" achievement should unlock immediately
-- ============================================================================
